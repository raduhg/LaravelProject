...
<body class="bg-gray-900">
    <header class="bg-gray-900 bg-opacity-65 fixed w-full px-4 sm:px-8 lg:px-16 py-4 z-20 top-0 start-0">
        <div class="flex items-center justify-between">
            <a href="{{ route('upcoming-trips.index') }}">
                <img src="{{ asset('images/logo2.png') }}" alt="App Logo" class="h-12 w-auto" />
            </a>
            ...
            <nav class="flex items-center">
                ...
                <a href="{{ url('/dashboard') }}"
                    class="rounded-md px-3 py-2 ring-1 ring-transparent transition focus:outline-none text-xl focus-visible:ring-[#FF2D20] text-white hover:text-white/80">
                    Dashboard
                </a>
                @else
                <a href="{{ route('login') }}"
                    class="rounded-md px-3 py-2 ring-1 ring-transparent transition focus:outline-none focus-visible:ring-[#FF2D20] text-xl text-white hover:text-white/80">
                    Log in
                </a>

                @if (Route::has('register'))
                <a href="{{ route('register') }}"
                    class="rounded-md px-3 py-2 ring-1 ring-transparent transition focus:outline-none focus-visible:ring-[#FF2D20] text-xl text-white hover:text-white/80 ml-2 sm:ml-4">
                    Register
                </a>
                @endif
                @endauth
        ...
        <div class="container min-w-full min-h-screen flex flex-row">
            <div class="mx-3 sm:ml-4 sm:basis-2/3 flex flex-col justify-end items-center mb-20">
                <div class="text-white text-center p-4 sm:p-6 rounded-xl">
                    ...
                    <p class="mt-4 text-2xl font-semibold">Being alive and living are two different things. We encourage
    ...
    <a id="about_section">
        ...
        <div
            ...
            <div class="mx-3 md:mx-6 lg:basis-1/3 justify-center items-center text-2xl font-medium">
                <p>We are a group of friends who, for about six years now, have been hiking and camping across the country,
                    ...
                    We started as a team of five highschoolers who hiked with their dad's equiment. Later, as more of us
                    got
                    ...
                    organised tens of camping trips, became more experienced, and founded this platform so anybody can
                    join
                    us.
                <p>
            </div>
        ...
        <div class="bg-gray-900 text-white bg-opacity-5 py-8">
            <div class=" text-center ">
                <p class="text-2xl mx-16 ">If you want to join us on a trip, see other member's posts, or learn more
                    about us and what we do, become a member! </p>
                <div class="my-8">
                    <a href="{{ route('register') }}"
                        class=" p-2 sm:py-2  px-10 rounded-3xl bg-orange-500 text-white font-semibold">Become
                        a member!</a>
                </div>
            </div>
        </div>
    ...
    <a id="contact_section">
        ...
        <div
            class="container bg-gray-900 text-white bg-opacity-5 min-w-full flex flex-col justify-center items-center gap-8 pb-6">
            ...
            <div class="bg-gray-100 bg-opacity-10 rounded-xl p-8">
                ...
                <form class="w-full md:w-72 lg:w-96" action="{{ route('contact.store')}}" method="POST">
                    @csrf
                    <label for="email-address-icon" class="block my-2 text-md font-semibold text-gray-100 ">Your
                        Name</label>
                    <div class="relative">
                    ...
                    <label for="message" class="block my-2 text-md font-semibold text-gray-100 ">Your
                        message</label>
                    ...
                    <br>
                    <button type="submit"
                        class="text-white text-md font-semibold bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-4 focus:ring-orange-300 rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">Submit</button>

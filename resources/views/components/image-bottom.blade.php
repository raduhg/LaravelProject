<style>
    ...
    .svg-body-bottom {
        background-color: rgba(17, 24, 39, {{$slot}});
    }
</style>
<div class="svg-body-bottom">
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 100 2" enable-background="new 0 0 100 2"
        width="100%" height="2vw" preserveAspectRatio="none">
